...
public class Tomador extends Cliente{
    ...
    public Tomador(int idClienteAsegurado, int edadA, int Cliente_idCliente, int idCliente, int documento, String tipoDocumento, String nombre, String apellido, String direccion, int telefono, Date fechanacimiento) {
