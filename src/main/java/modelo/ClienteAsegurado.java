...
public class ClienteAsegurado extends Cliente {
    ...
    public ClienteAsegurado(int idClienteAsegurado, int edadA, int idCliente, int documento, String tipoDocumento, String nombre, String apellido, String direccion, int telefono, Date fechanacimiento) {
